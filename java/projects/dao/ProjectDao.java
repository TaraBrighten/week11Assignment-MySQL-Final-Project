 ...
 * user can see category of project in console
 */
...
/**
 * Method that retrieves and lists rows from Step table that
 * are linked by the project id already called so that
 * user can see steps to complete project in console
 */
...
/**
 * Method that retrieves and lists rows from Material table that
 * are linked by the project id already called so that
 * user can see materials needed for project in console
 */
